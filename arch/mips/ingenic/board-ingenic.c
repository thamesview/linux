...
static __init char *ingenic_get_system_type(unsigned long machtype)
{
	...
	case MACH_INGENIC_T31:
		return "T31";
	case MACH_INGENIC_T40:
		return "T40";
	case MACH_INGENIC_T41:
		return "T41";
...
static const struct of_device_id ingenic_of_match[] __initconst = {
	...
	{ .compatible = "ingenic,t40",   .data = (void *)MACH_INGENIC_T40 },
	{ .compatible = "ingenic,t41",   .data = (void *)MACH_INGENIC_T41 },
	{}
};
...
{
	super_early_printk("ingenic_halt\n");
	for (;;)
		ingenic_wait_instr();
}
...
static void ingenic_restart(char *command)
{
	...
	super_early_printk("ingenic_restart\n");
...
{
	super_early_printk("ingenic_pm_init()\n");
...
static int __init ingenic_pm_clk_setup(char *s) {
	...
	super_early_printk("ingenic_pm_clk_setup()\n");
